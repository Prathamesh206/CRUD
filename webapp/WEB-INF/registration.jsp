			...
			<form class="row g-3" action="registration" method="post">
				<div class="col-12">
					<label for="firstName" class="form-label">FirstName</label> <input
						...
						id="inputAddress2" required="required">
				</div>
				<div class="col-12">
				...
				<div class="col-md-6">
					<label for="inputEmail4" class="form-label">city</label> <input
						type="text" name="city" class="form-control" id="inputEmail4" required="required">
				</div>
				<div class="col-md-6">
					<label for="inputPassword4" class="form-label">job</label> <input
						type="text" name="job" class="form-control" id="inputPassword4" required="required">
				</div>
				<div class="row d-flex justify-content-left mb-5 mt-5">
					<div class="col-md-6">
					<lable for="education" class="form-label">Educations</lable>
						<select id="choices-multiple-remove-button" name="education" required="required"
						 multiple>
						 <%
				...
				<div class="col-12">
					<div class="form-check">
						<input class="form-check-input" type="checkbox" id="gridCheck"
							name="check" required="required"> <label class="form-check-label"
